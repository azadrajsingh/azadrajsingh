...
<img src="https://komarev.com/ghpvc/?username=azadrajsingh&label=Profile%20Views&color=6366f1&style=for-the-badge" alt="Profile Views"/>
<img src="https://img.shields.io/badge/Status-Open%20to%20Opportunities-22c55e?style=for-the-badge&logo=statuspage&logoColor=white" alt="Status"/>
<img src="https://img.shields.io/badge/Location-Jaipur%2C%20India-f97316?style=for-the-badge&logo=googlemaps&logoColor=white" alt="Location"/>
...
## <img src="https://media.giphy.com/media/hvRJBFJWlYXrKS4wdD/giphy.gif" width="28"> About Me
...
graph TB
    subgraph Client["🖥️ Client Layer"]
        NEXT["Next.js / React<br/>SSR · RSC · Tailwind"]
        MOBILE["Mobile / PWA"]
    end
    ...
    MOBILE --> NGINX
    NGINX --> REST & GQL & WS
    REST --> NODE & NEST & LARAVEL
    WS --> NODE
    NODE & NEST --> MONGO & PG & REDIS
    LARAVEL --> MYSQL & PG & REDIS
    NODE & LARAVEL --> BULL --> WORKERS
    Backend --> DOCKER --> AWS --> CICD
```
...
<img src="https://skillicons.dev/icons?i=js,ts,react,nextjs,nodejs,express,nestjs,laravel,php,mongodb,postgresql,mysql,redis,docker,aws,nginx,git,github,postman,vscode&perline=10" alt="Tech Icons"/>
